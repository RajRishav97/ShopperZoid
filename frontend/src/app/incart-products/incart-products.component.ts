...
=======
<<<<<<< HEAD
    this.route.navigate(['./payment', { email: this.emailId,name: "",amount: this.sum }]);
=======
    this.route.navigate(['/payment', { email: this.email, amount: this.totalAmount }]);
>>>>>>> 7ed71633b11fa8f35c4c432bbb6cee8e7d6ac5b1
>>>>>>> 7baca7d711aa8e6846350ae70f5a04a7d392c2e5
  }
